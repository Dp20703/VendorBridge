...
export const AuthScreens: React.FC = () => {
  ...
  const [loginEmail, setLoginEmail] = useState(
    "sarah.jenkins@vendorbridge.com",
  );
  ...
  const [regRole, setRegRole] = useState<
    UserRole.PROCUREMENT | UserRole.VENDOR
  >(UserRole.VENDOR);
  ...
  const handleRegisterSubmit = (e: React.FormEvent) => {
    ...
    if (!regFirstName.trim())
      errs.firstName = "First Name is strictly required.";
    if (!regLastName.trim()) errs.lastName = "Last Name is strictly required.";
    if (!regEmail.includes("@"))
      errs.email = "Requires complete valid email address.";
    if (!regPhone.trim())
      errs.phone = "Requires functional phone callback number.";
    if (!regCompanyName.trim())
      errs.companyName = "Requires registered enterprise identity name.";
    if (regRole === UserRole.VENDOR && !regGstNumber.trim()) {
      errs.gstNumber =
        "Tax / GST registration is mandatory for Vendor accounts.";
    }
      ...
      <div className="hidden lg:flex lg:col-span-5 flex-col justify-between p-12 bg-gradient-to-br from-slate-900 via-slate-950 to-emerald-950/40 relative border-r border-slate-900 overflow-hidden">
        ...
        <div className="my-auto relative z-10 max-w-sm">
          <h1 className="text-3xl font-extrabold font-display leading-[1.15] text-white tracking-tight">
            ...
            <span className="text-emerald-400">Enterprise Procurement</span>{" "}
            Pipelines.
          </h1>
          <p className="mt-4 text-xs text-slate-400 leading-relaxed font-sans">
            Streamline RFQs, generate side-by-side bid comparisons instantly,
            manage rigorous internal workflows, and disburse secure Purchase
            Orders.
          </p>
          ...
          <AnimatePresence mode="wait">
            ...
            {screen === "login" && (
              ...
              >
                ...
                <p className="mt-1.5 text-xs text-slate-400 font-sans">
                  Enter credentials to interface with ERP registries.
                </p>
                ...
                <form className="mt-6 space-y-4" onSubmit={handleLoginSubmit}>
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            if (role === UserRole.ADMIN)
                              setLoginEmail("alexander.vance@vendorbridge.com");
                            else if (role === UserRole.PROCUREMENT)
                              setLoginEmail("sarah.jenkins@vendorbridge.com");
                            else if (role === UserRole.MANAGER)
                              setLoginEmail(
                                "sophia.rodriguez@vendorbridge.com",
                              );
                            else if (role === UserRole.VENDOR)
                              setLoginEmail("marcus@apexindustrial.com");
                          }}
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      <label className="text-[10px] uppercase font-mono font-bold tracking-wider text-slate-400">
                        Secure Pin Code / Password
                      </label>
                      <button
                        type="button"
                  ...
                  <div className="flex items-center">
                    ...
                    <label
                      htmlFor="remember-me"
                      className="ml-2 text-xs text-slate-400 font-sans select-none cursor-pointer"
                    >
            ...
            {screen === "register" && (
              ...
              >
                ...
                <p className="mt-1.5 text-xs text-slate-400 font-sans">
                  Self-registration limited strictly to PROCUREMENT and VENDOR
                  roles.
                </p>
                ...
                {regSuccess ? (
                  <div className="mt-6 py-8 text-center flex flex-col items-center justify-center">
                    ...
                    <p className="text-xs text-slate-400 font-sans mt-1">
                      Booting secure telemetry logs & redirecting...
                    </p>
                  </div>
                ) : (
                  <form
            ...
            {screen === "forgot" && (
              ...
              >
                ...
                <p className="mt-1.5 text-xs text-slate-400 font-sans">
                  Enter your workspace corporate email address to receive
                  simulation override credentials.
                </p>
                ...
                {forgotSuccess ? (
                  <div className="mt-6 py-6 text-center space-y-4">
                    ...
                    <p className="text-xs text-slate-400 font-sans max-w-xs mx-auto leading-relaxed">
                      We have simulated a secure credentials override link for{" "}
                      <strong className="text-emerald-400">
                        {forgotEmail}
                      </strong>
                      . Click below to instantly open the secure change panel.
                    </p>
                    <button
                      onClick={() => {
                        setScreen("reset");
            ...
            {screen === "reset" && (
              ...
              >
                ...
                <p className="mt-1.5 text-xs text-slate-400 font-sans">
                  Set your new high-entropy corporate access credentials below.
                </p>
                ...
                {resetSuccessStatus ? (
                  <div className="mt-6 py-6 text-center space-y-4 w-full">
                    ...
                    <p className="text-xs text-slate-400 font-sans max-w-xs mx-auto leading-relaxed">
                      Your new credentials have been updated and are now live.
                      You can now log into your suite instantly.
                    </p>
                    <button
                      onClick={() => {
                        setScreen("login");
